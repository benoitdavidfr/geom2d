...
*/
  static function chg($src, $dest, $x, $y) {
    ...
    switch("$src-$dest") {
      case 'L93-geo':
        $ret = Lambert93::geo($x, $y); break;
      case 'geo-L93':
        $ret = Lambert93::proj($x, $y); break;
      case 'WM-geo':
        $ret = WebMercator::geo($x, $y); break;
      case 'geo-WM':
        $ret = WebMercator::proj($x, $y); break;
      case 'UTM-geo':
        $ret = $utm->geo($x, $y); break;
      case 'geo-UTM':
        $ret = $utm->proj($x, $y); break;
      default:
